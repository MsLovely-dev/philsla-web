...
| **Ian Chris Sandoval (I.Sandoval)** | Maintenance Table – Exam Blueprint | Maintenance & Config | In progress; resumption gates authorized 2026-08-06, design spec reviewed and approved (`docs/superpowers/i.sandoval/specs/2026-08-06-exam-blueprint-maintenance-design.md`), implementation plan next | 🟢 Ticket 001 resumed | `worktrees/i.sandoval/` | `i.sandoval/exam-blueprint-maintenance` | `docs/superpowers/i.sandoval/i.sandoval.task.md` |

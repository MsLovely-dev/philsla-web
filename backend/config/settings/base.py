...
STEP1_SELFIE_MIN_IMAGE_WIDTH = env_int("STEP1_SELFIE_MIN_IMAGE_WIDTH", 720)
STEP1_SELFIE_MIN_IMAGE_HEIGHT = env_int("STEP1_SELFIE_MIN_IMAGE_HEIGHT", 720)
...
STEP1_SELFIE_MIN_LAPLACIAN_VARIANCE = float(os.environ.get("STEP1_SELFIE_MIN_LAPLACIAN_VARIANCE", "100"))

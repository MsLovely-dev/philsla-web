...
LRN_DEPED_VERIFY_URL = os.environ.get("LRN_DEPED_VERIFY_URL", "")
LRN_DEPED_API_TOKEN = os.environ.get("LRN_DEPED_API_TOKEN", "")
LRN_DEPED_TIMEOUT_SECONDS = env_int("LRN_DEPED_TIMEOUT_SECONDS", 10)
...
SCORE_RELEASE_EMAIL_PROCESSING_TIMEOUT_SECONDS = env_int("SCORE_RELEASE_EMAIL_PROCESSING_TIMEOUT_SECONDS", 900)

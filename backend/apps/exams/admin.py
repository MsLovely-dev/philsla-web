...
@admin.register(ReferenceYear)
class ReferenceYearAdmin(admin.ModelAdmin):
    list_display = ("year", "academic_year", "created_at", "updated_at")
    search_fields = ("year", "academic_year__name")
...
class BlueprintVersionAdmin(admin.ModelAdmin):
    list_display = ("blueprint", "version_number", "name", "status", "academic_year", "reference_year", "created_at")

...
class ReferenceYear(models.Model):
    academic_year = models.OneToOneField(AcademicYear, on_delete=models.CASCADE, related_name="reference_year")
...
class BlueprintVersion(models.Model):
    ...
    reference_year = models.ForeignKey(
        "ReferenceYear",
        on_delete=models.PROTECT,

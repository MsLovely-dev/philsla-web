...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(model_name="examreviewitem", name="ai_proposed_score", field=models.PositiveSmallIntegerField(blank=True, null=True)),
        migrations.AddField(model_name="examreviewitem", name="answer_options", field=models.JSONField(blank=True, default=list)),
        migrations.AddField(model_name="examreviewitem", name="response_seconds", field=models.PositiveIntegerField(default=0)),

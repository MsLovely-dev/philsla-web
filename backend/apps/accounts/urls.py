...
urlpatterns = [
    ...
    path("admin/roles/<str:role>/permissions/", AdminRolePermissionView.as_view(), name="admin-role-permissions"),
    ...
    path("login/password/change/", TemporaryPasswordChangeView.as_view(), name="login-password-change"),

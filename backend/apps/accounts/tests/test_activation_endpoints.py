...
class ActivationEndpointTests(TestCase):
    ...
    def test_student_registration_activation_boundary_waits_for_registration_storage(self) -> None:
        client = APIClient()
        ...
        self.assertEqual(
            ...
            "Student account activation is unavailable until registration approval storage exists.",
        )

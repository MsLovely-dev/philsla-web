      ...
      <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        <div className="border-b border-slate-200 bg-gradient-to-r from-slate-950 to-slate-800 px-5 py-6 text-white sm:px-7">
          ...
          <p className="mt-1 max-w-2xl text-sm text-slate-300">
            This route now exists as a dedicated destination for exam-set audit review.
          </p>
        </div>

        <div className="flex min-h-64 flex-col items-center justify-center gap-3 p-8 text-center">
          <FileText className="h-10 w-10 text-slate-400" />
          <h2 className="text-lg font-black text-slate-900">Audit routing is now separated</h2>

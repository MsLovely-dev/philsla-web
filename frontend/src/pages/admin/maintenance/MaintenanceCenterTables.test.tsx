...
describe('active Maintenance Center tables', () => {
  ...
  it('loads the seeded schools from the service and ignores saved browser data', async () => {
    ...
    expect(await screen.findByText('Manila Science High School')).toBeInTheDocument();
